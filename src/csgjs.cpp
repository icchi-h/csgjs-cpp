...
{
    std::vector<csgjs_polygon> temp_polygon = csgjs_modelToPolygons(a);
    csgjs_csgnode * A = new csgjs_csgnode(temp_polygon);
...
inline csgjs_vertex csgjs_cubeVertex(csgjs_vector pos, csgjs_vector normal, const int center[])
{
    pos.x += center[0];
    pos.y += center[1];
    pos.z += center[2];
...
csgjs_model csgjs_cube(const int size, const int center[])
{
    ...
    std::vector<csgjs_vertex> vertices;
    // front
    vertices.push_back(csgjs_cubeVertex(positions[0], normals[4], center));
    vertices.push_back(csgjs_cubeVertex(positions[1], normals[4], center));
    vertices.push_back(csgjs_cubeVertex(positions[5], normals[4], center));
    vertices.push_back(csgjs_cubeVertex(positions[4], normals[4], center));
    // left
    vertices.push_back(csgjs_cubeVertex(positions[3], normals[1], center));
    vertices.push_back(csgjs_cubeVertex(positions[0], normals[1], center));
    vertices.push_back(csgjs_cubeVertex(positions[4], normals[1], center));
    vertices.push_back(csgjs_cubeVertex(positions[7], normals[1], center));
    // back
    vertices.push_back(csgjs_cubeVertex(positions[2], normals[5], center));
    vertices.push_back(csgjs_cubeVertex(positions[3], normals[5], center));
    vertices.push_back(csgjs_cubeVertex(positions[7], normals[5], center));
    vertices.push_back(csgjs_cubeVertex(positions[6], normals[5], center));
    // right
    vertices.push_back(csgjs_cubeVertex(positions[1], normals[0], center));
    vertices.push_back(csgjs_cubeVertex(positions[2], normals[0], center));
    vertices.push_back(csgjs_cubeVertex(positions[6], normals[0], center));
    vertices.push_back(csgjs_cubeVertex(positions[5], normals[0], center));
    // top
    vertices.push_back(csgjs_cubeVertex(positions[4], normals[2], center));
    vertices.push_back(csgjs_cubeVertex(positions[5], normals[2], center));
    vertices.push_back(csgjs_cubeVertex(positions[6], normals[2], center));
    vertices.push_back(csgjs_cubeVertex(positions[7], normals[2], center));
    // bottom
    vertices.push_back(csgjs_cubeVertex(positions[4], normals[3], center));
    vertices.push_back(csgjs_cubeVertex(positions[3], normals[3], center));
    vertices.push_back(csgjs_cubeVertex(positions[2], normals[3], center));
    vertices.push_back(csgjs_cubeVertex(positions[1], normals[3], center));
